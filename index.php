...
<head>
  ...
  <style>
    ...
    .panel-heading {
      color: #fff !important;
      background-color: #41CBBF !important;
      padding: 25px;
  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><span style="color:#41CBBF;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -ADMIN</b></span></h4>
          </div>
              ...
              <div class="col-md-6">
                <form role="form" method="post" action="head.php?q=index.php">
                  <div class="form-group">
                    <input type="text" name="uname" maxlength="20" placeholder="Admin user id" class="form-control" style="padding:1rem 2rem;" />
                  </div>
                  <div class="form-group">
                    <input type="password" name="password" maxlength="15" placeholder="Password" class="form-control" style="padding:1rem 2rem;" />
                  </div>
                  <div class="form-group" align="center">
                    <input type="submit" name="login" value="Login" class="btn btn-primary" style="background-color: #0A3342; color:#FFFFFF" />
                  </div>
                </form>
              </div>
              <div class="col-md-3"></div>
    ...
    <div class="modal fade" id="login2">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title"><span style="color:#41CBBF;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -TEACHER</b></span></h4>
          </div>
          <div class="modal-body title1">
            <div class="row">
              <div class="col-md-3"></div>
              <div class="col-md-6">
                <form role="form" method="post" action="admin.php?q=index.php">
                  <div class="form-group">
                    <input type="text" name="uname" maxlength="20" placeholder="Teacher user id" class="form-control" style="padding:1rem 2rem;" />
                  </div>
                  <div class="form-group">
                    <input type="password" name="password" maxlength="15" placeholder="Password" class="form-control" style="padding:1rem 2rem;" />
                  </div>
                  <div class="form-group" align="center">
                    <input type="submit" name="login2" value="Login" class="btn btn-primary" style="background-color: #0A3342; color:#FFFFFF" />
                  </div>
                </form>
              </div>
              <div class="col-md-3"></div>
      ...
      <div class="modal-dialog">
        <div class="modal-content title1">
          <div class="modal-header">
            ...
            <h4 class="modal-title title1"><span style="color:#41CBBF;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -USER</b></span></h4>
          </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btn " style="background-color: #0A3342; color:#FFFFFF" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary" style="background-color: #0A3342; color:#FFFFFF">Log in</button>
            </fieldset>
            </form>
          </div>
        </div><!-- /.modal-content -->
    ...
    <div class="modal fade" id="myModal1">
      <div class="modal-dialog">
        <div class="modal-content title1">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="font-size: 3rem !important;"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title title1"><span style="color:#41CBBF;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px;  "><b>SIGN UP</b></span></h4>
          </div>
          <div class="modal-body">
            <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="submit" style="background: #41CBBF; border:none; padding:.5rem 1rem; border-radius:0.25rem; transition:all 1s ease-in-out; border:.5px solid #DDE2EE" class="sub" value="sign up" />
                  </div>
                </div>
              </fieldset>
            </form>
    ...
    <div id="services" class="container-fluid text-center">
      ...
      <div class="row slideanim">
        <div class="col-sm-4">
          ...
          <i class="material-icons" style="font-size:60px;color:#41CBBF">group_add</i>
          <h4>e Examination</h4>
          <p style="font-size: 1.5rem;"> Multiple users One platform</p>
        </div>
        <div class="col-sm-4">
          <span class="glyphicon glyphicon-euro logo-small"></span>
          <h4>COST OPTIMISED</h4>
          <p style="font-size: 1.5rem;">Reduces paper work</p>
        </div>
        <div class="col-sm-4">
          <span class="glyphicon glyphicon-user logo-small"></span>
          <h4>USER SATISFACTION</h4>
          <p style="font-size: 1.5rem;">User satisfaction is our satisfaction..</p>
        </div>
      </div>
      <br><br>
      <div class="row slideanim">
        <div class="col-sm-4">
          ...
          <h4>GREEN</h4>
          <p style="font-size: 1.5rem;">Eco friendly</p>
        </div>
        <div class="col-sm-4">
          <span class="glyphicon glyphicon-certificate logo-small"></span>
          <h4>CERTIFIED</h4>
          <p style="font-size: 1.5rem;">Certified from the government of Bangladesh..</p>
        </div>
        <div class="col-sm-4">
          <span class="glyphicon glyphicon-envelope logo-small"></span>
          <h4 style="color:#303030;">CONTACT US</h4>
          <p style="font-size: 1.5rem;">Contact us directly for help..</p>
        </div>
      </div>
    </div>
    ...
    <div id="developers" class="container-fluid text-center bg-grey">
      <h2>Developers</h2><br>
      <h4>Who Am I?</h4>
      <div class="row text-center slideanim" style="display: flex; justify-content:center; align-items:center;">
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="./img/myself.jpg" alt="Picture1" width="400" height="300">
            <h3><strong>Suvronil Dey Niloy</strong></h3>
            <h5>Email: suvronil.cse.pstu@gmail.com</h5>
            <h5>Mobile: 01731955730</h5>
            <h5>Address: Khulna,Bangladeshh5>
          </div>
        </div>
      </div>
    ...
    <div id="about" class="container-fluid">
      <div class="row">
        <div class="col-sm-8">
          ...
          <br><button class="btn  btn-lg" style="background-color: #0A3342; color:#FFFFFF">Get in Touch</button>
        </div>
        <div class="col-sm-4">
    ...
    <!-- <div id="contact" class="container-fluid bg-grey">
      ...
      <div class="row">
        <div class="col-sm-5">
          ...
          <p><span class="glyphicon glyphicon-map-marker"></span> PSTU</p>
      ...
      <div class="row">
        <div class="col-sm-12 form-group">
          <button class="btn pull-right" style="background-color: #0A3342; color:#FFFFFF" name="submit" input type="submit">send</button>
        </div>
      </form>';
          } ?>
        </div>
